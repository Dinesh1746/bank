...
namespace bank.Controllers
{
    ...
    public class TransactionsController : ControllerBase
    {
        ...
        public TransactionsController(BankingProjectContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != transactions.Transactionno)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Transactions>> PostTransactions(Transactions transactions)
        {
            ...
            return CreatedAtAction("GetTransactions", new { id = transactions.Transactionno }, transactions);
        }
        ...
        {
            return _context.Transactions.Any(e => e.Transactionno == id);
        }
    }
}
